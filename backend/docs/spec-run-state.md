...
| SPEC-2-01 | 2 | DATABASES hardcoded sqlite3 (settings.py:92-97) — make env-driven (e.g. dj-database-url) with sqlite dev fallback; Postgres provisioning itself stays deferred — Owner: build now; deployment/FTS deferred to S22/S9 | 152–278 [2.4] | BUGS-FOUND (GATE_PHASE SENT-BACK cycle-1 @ 6819520: BUG-1 P2 GitGuardian incident 37423839 "Generic Password" — false positive on placeholder fixture `db['PASSWORD'] == 'p@ss'` at backend/tests/test_settings_security.py:97 (commit 313782e); blocks promotion PR #3 merge. Builder fix: restructure assertion so no password-shaped literal exists. All RE gate checks otherwise green; CI floor held 261/6expF/100.00%) | 2 |
