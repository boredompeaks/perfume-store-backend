...
| SPEC-6-03 | 6 | RBAC foundation: Group-based roles (support/catalogue/inventory/marketing/finance/admin) + capability permission classes applied to API views; replaces binary is_staff for authorization decisions | 1425–2262 [6.12.2],[6.12.4],[6.12.7] = §6.12 lines 2099–2262 | BUILDING (builder dispatched 2026-09-18, post-merge tree @ 5d41471; floor 261/6expF/100.00%) | 1 |
