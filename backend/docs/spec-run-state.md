...
| SPEC-6-03a | 6 | RBAC I: six staff roles (support/catalogue/inventory/marketing/finance/admin) as Groups + capability→role mapping in one module + idempotent seeding (makemigrations --check stays clean) + seeding idempotency test | 1425–2262 §6.12 lines 2099–2262 [6.12.2],[6.12.4],[6.12.7] | BUILT (commit 4a3f770: common/roles.py + data migration 0001 + common added to INSTALLED_APPS [declared, justified]; 263 tests = 257 pass + 6 xfails, cov 100.00%; audit deferred to combined 03a+03b+03c audit) | 1 |
| SPEC-6-03b | 6 | RBAC II: DRF capability permission classes added to backend/common/permissions.py (extend IsAdminUserOrReadOnly seam, no duplication; Group/permission-based; admin role = full staff authority) + allow/deny + role→capability matrix tests | 1425–2262 §6.12 lines 2099–2262 | BUILT (commit 3e0934f: get_user_roles/user_has_capability/CapabilityPermission + factory + 14 named subclasses; 273 tests = 267 pass + 6 xfails, cov 100.00%. ANOMALY: external checkout moved main tree to UI/UX mid-build, commit landed there; remediated via temp worktree ff spec-comp d5de6fb→3e0934f, UI/UX + user worktree untouched; audit deferred to combined 03a+03b+03c audit) | 1 |
| SPEC-6-03c | 6 | RBAC III: apply capability permission classes to API views (no guard downgrades — everything staff-only stays at-least-as-restricted); role/permission changes restricted to admin role (privilege-escalation guard, spec line 2261) | 1425–2262 §6.12 lines 2099–2262 | BUILT (commit 2736990: products FBVs on capability gate; ops/dashboard deliberately deferred to 6-04/05 [template view]; orders/cart/accounts audited customer-scoped; role-less is_staff lose product writes [tightening, flagged for auditor]; 285 tests = 279 pass + 6 xfails, cov 100.00%; combined 03a+03b+03c audit dispatched) | 1 |
